...
Poetic Programming is a view of programming that emphasizes the importance of meaning.  Programming is a form of writing, and its primary purpose, as with all writing, is to communicate.  At a minimum a program should communicate to readers what it does.  Ideally a program should go far beyond this and paint a picture of the world the program lives in and the aspirations that led to it.
